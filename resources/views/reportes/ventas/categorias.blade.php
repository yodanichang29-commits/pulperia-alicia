...
<x-app-layout>
  ...
  <div class="max-w-7xl mx-auto p-4">
    ...
    <form id="filtros" class="bg-white p-4 rounded-xl shadow flex flex-col sm:flex-row gap-3 mb-4">
      ...
      <div class="flex-1">
        ...
        <input type="text" id="q" value="{{ $q }}" placeholder="Categoría o producto…"
    ...
    {{-- Zona dinámica --}}
  <div id="zona-lista">
  @include('reportes.ventas.partials.categorias_contenido', ['rows'=>$rows,'total_general'=>$total_general,'detalle'=>$detalle])
</div>
  ...
  (function(){
    ...
    async function cargar(){
      const url = new URL(`{{ route('reportes.ventas.categorias') }}`, window.location.origin);
